...
(function(factory) {
    ...
    $.dateRangePickerLanguages = {
        ...
        "vi": {
            ...
            "shortcuts": "Pintas",
            "custom-values": "Giá trị lựa chọn",
            "past": "Trước đó",
            "following": "Following",
            "previous": "Trước đó",
            "prev-week": "Tuần trước",
            ...
            "next-year": "Năm sau",
            "less-than": "Không lựa chọn quá %d ngày",
            "more-than": "Không lựa chọn ít hơn %d ngày",
            "default-more": "Vui lòng lựa chọn nhiều %d ngày",
            "default-single": "Vui lòng lựa chọn ngày",
            "default-less": "Vui lòng chọn ít hơn %d ngày",
            "default-range": "Vui lòng chọn từ %d đến %d ngày",
            "default-default": "Vui lòng chọn thời gian",
            "time": "Thời gian",
            "hour": "Giờ",
            "minute": "Phút"
        },
    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        opt = $.extend(true, {
            ...
            hoveringTooltip: function(days, startTime, hoveringTime) {
                return days > 1 ? days + ' ' + translate('days') + ' ' + (days - 1) + ' '+ translate('nights') : '';
            },
            showTopbar: true,
            swapTime: false,
        ...
        function showSelectedInfo(forceValid, silent) {
            ...
            if (opt.start && opt.singleDate) {
                ...
                box.find('.selected-days').show().find('.selected-nights-num').html(countDays(opt.end, opt.start) -1);
                box.find('.apply-btn').removeClass('disabled');
        ...
        function createDom() {
            ...
            if (opt.showTopbar) {
                ...
                if (opt.customTopBar) {
                    ...
                    if (!opt.singleDate) {
                        html += ' <span class="separator-day">' + opt.separator + '</span> <b class="end-day">...</b> <i class="selected-days">(<span class="selected-days-num">3</span> ' + translate('days') + ' <span class="selected-nights-num"> 3</span> ' + translate('nights') + ')</i>';
                    }
                    html += '</div>';
